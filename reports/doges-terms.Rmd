...
doges.years.all[doges.years.all$Start >= 1329,]$pre.serrata <- FALSE
...
The Pettitt test [@pettitt1979non], which works better for smaller series, yields a change point at index 9; however, this has a p-value higher than 0.05 and thus we need to conclude that there is, indeed, no significant structural change in this period, not even after the introduction of the electoral college, as affirmed by [@smith2021long].

There seems to be also some significant change by the end of the republic; we will test again from this doge on looking for this change. 
