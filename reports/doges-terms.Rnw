...
the Republic. \rev{The \emph{serrata}, even if identified as an individual event in a point in time, can be rather considered an extended period of legal and social change that extended along more than thirty years \cite{roesch00}. }
...
\rev{The \emph{serrata} was not the last watershed event; some authors \cite{roesch00,chojnacki00} talk about a second and even a third \emph{serrata}. }
