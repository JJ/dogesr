...
other languages), \rev{which was elected for life}. \rev{Although initially they were chosen in a popular assembly, eventually and d}uring the longest period, doges were elected by an electoral college composed of 41 nobles, which were also \rev{chosen}
