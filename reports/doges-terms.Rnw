...
<<r distribution, fig.pos="h!tbp", fig.height=4, echo = FALSE, fig.cap="This histogram reproduces, with a fixed bin size, Figure 1 in \\protect\\cite{smith2021long}.\\protect\\label{fig:histo}">>=
library(ggplot2)
ggplot(doges.years.all, aes(x=Years))+geom_histogram(binwidth=5)
@


<<r boxplot, echo = FALSE, fig.pos="h!tbp", fig.height=4,fig.cap="Boxplot of doge duration in office vs. century.\\protect\\label{fig:boxplot}">>=
doges.years.all$Century <- as.factor(doges.years.all$Century)
ggplot(doges.years.all, aes(x=Century,y=Years))+geom_boxplot()
@


<<r serrata, echo=FALSE, fig.pos="h!tbp", fig.height=4, fig.cap="Box-and-whiskers plot of the span, in years, of doges in office pre and post 1329 (indicated with the pre.serrata variable).\\protect\\label{fig:serrata}">>=
...
<<r decline, echo=FALSE, fig.pos="h!tbp", fig.height=4, fig.cap="Box-and-whiskers plot of the span, in years, of doges in office after 1329 and pre and post 1658 (indicated with the pre.decline variable).\\protect\\label{fig:decline}">>=
